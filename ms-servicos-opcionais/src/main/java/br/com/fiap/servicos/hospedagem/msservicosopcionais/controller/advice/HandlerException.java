...
public class HandlerException {
    ...
    public ResponseEntity<?> itemNaoEncontradoException(ItemNaoEncontradoException ex) {
        logger.error("Erro ao lidar com ItemNaoEncontradoException", ex);
    ...
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ResponseEntity<?> servicoNaoEncontradoException(ServicoNaoEncontradoException ex) {
        logger.error("Erro ao lidar com ServicoNaoEncontradoException", ex);
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new ErrorResponseDetails(ex.getMessage()));
    }
