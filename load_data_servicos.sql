...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'ITENS') THEN
        ...
        INSERT INTO ITENS (id, nome_item, descricao_item, valor_item, id_hotel)
        VALUES
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'SERVICOS') THEN
        ...
        INSERT INTO SERVICOS (id, nome_servico, descricao_servico, valor_servico, id_hotel)
        VALUES
        -- Hotel 1
        ...
        -- Hotel 3
        (11, 'Aulas de Ioga', 'Aulas de Ioga no jardim do hotel', 30.00, 3),
        (12, 'Transfer do Aeroporto', 'Serviço de transfer do aeroporto para o hotel', 45.00, 3),
        ...
        -- Hotel 6
        (26, 'Aula de Mergulho', 'Aulas de mergulho na piscina do hotel', 60.00, 6),
