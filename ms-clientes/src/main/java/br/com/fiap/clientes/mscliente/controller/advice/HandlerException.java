...
public class HandlerException {
    ...
    public ResponseEntity<?> clienteNaoEncontradoException(ClienteNaoEncontradoException ex) {
        logger.error("Erro ao lidar com ClienteNaoEncontradoException", ex);
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new ErrorResponseDetails(ex.getMessage()));
    }

    @ExceptionHandler(NumeroDePassaporteNaoInformadoException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResponseEntity<?> numeroDePassaporteNaoInformadoException(NumeroDePassaporteNaoInformadoException ex) {
        logger.error("Erro ao lidar com NumeroDePassaporteNaoInformadoException", ex);
